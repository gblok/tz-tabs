...
//export const LazyComponent = (path, chunkName ='Test') =>  import(/*webpackChunkName:"[chunkName]"*/ '../components/' + path)


export const LazyComponent = (path, name) => {

    console.log({name})


    return import(/* webpackChunkName: 'dyn-' */ '../components/' + path)
